CREATE DATABASE  IF NOT EXISTS `foro` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `foro`;
...
CREATE TABLE `subforo` (
  ...
  `fecha` date NOT NULL,
  CONSTRAINT `pk_Subforo` PRIMARY KEY (`id`),
  CONSTRAINT `unq_tema` UNIQUE(`titulo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `subforo`
--

LOCK TABLES `subforo` WRITE;
/*!40000 ALTER TABLE `subforo` DISABLE KEYS */;
/*!40000 ALTER TABLE `subforo` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tema` (
  ...
  CONSTRAINT `tema_idfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `respuesta` (
  ...
  CONSTRAINT `respuesta_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-05-15 20:37:24
